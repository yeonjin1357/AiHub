...
import { DisplayServiceFeature, convertToDisplayFeatures } from '@/lib/service-features';
...
if (isLoading) {
return (
<Card className={`${className} border-gray-200/60 shadow-sm`}>
<CardHeader>
...
: 'bg-white/50 border-gray-200/60 hover:bg-gray-50/80'
} transition-colors`}
>
<feature.icon
className={`h-5 w-5 mt-0.5 ${
feature.isHighlighted ? 'text-blue-600' : 'text-gray-500'
}`}
/>
...
return (
<Badge key={category} variant="outline" className="text-xs border-gray-200/50 bg-gray-50/50">
