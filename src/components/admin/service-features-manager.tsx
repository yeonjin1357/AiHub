...
import { 
  ...
  getCategoryDefaultFeatures 
} from '@/lib/service-features';
import { 
  getServiceFeatures, 
  bulkUpdateServiceFeatures,
  applyDefaultFeaturesToService 
} from '@/lib/api/service-features';
        ...
        {isEditing && (
          <div className="mb-4">
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="max-w-md border-gray-200/60 dark:border-gray-700/60 bg-white dark:bg-gray-800">
                <DialogHeader>
                  <DialogTitle>
                  ...
                  >
                    {(provided) => (
                      <div
                        ...
                        className={`flex items-center gap-3 p-3 border border-gray-200/60 dark:border-gray-700/60 rounded-lg bg-white/50 dark:bg-gray-800/50 ${
                          isEditing ? 'hover:bg-gray-50/80 dark:hover:bg-gray-700/60' : ''
                        }`}
                      >
                        {isEditing && (
                          <div
